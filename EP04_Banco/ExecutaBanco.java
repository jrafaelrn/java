...
public class ExecutaBanco {
	public static void main(String[] args){
		...
		Gerente ger3 = new Gerente("Gerente 2", 12121);
		...
		System.out.println("\n\n*** Testando o metodo obterEmprestimo **************************");
		...
		if (c4.obterEmprestimo(0))  System.out.println("Cliente '"  + c4.nome + "' obteve o emprestimo solicitado.");
		else  System.out.println("Cliente '"  + c4.nome + "' nao obteve o emprestimo solicitado.");
		...
		System.out.println("\n\n*** Testando o metodo realizarSaque ****************************");
